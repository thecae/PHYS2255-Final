    ...
    <div className="fixed top-0 left-0 w-screen h-screen flex justify-center items-center bg-nightfall-background bg-opacity-75 z-50">
      <div className="bg-nightfall-background border-4 border-solid border-nightfall-background clock-shadow rounded-xl p-4 max-w-3xl w-full m-4 flex flex-col shadow-xl">
        ...
        <ol className="list-decimal text-left font-extralight mt-4 ml-8">
          ...
          <li className="mt-2">
            Hold the <span className="border border-solid border-nightfall-background shadow-inner shadow-nightfall-highlight rounded-xl px-2 py-1 font-semibold">Shift</span> key and drag the mouse to rotate the camera around
            the simulation.
          </li>
          <li className="mt-2">
        ...
        <p className="mt-4">The goal of this simulation is to understand the effects of relativistic speeds, including time dilation and length contraction.</p>
        <p className="text-center italic mt-4 text-sm">Hope you enjoy! C.E. & J.S.</p>
        {onClose ? (
          <button
            onClick={onClose}
